...
const REQUIREMENTS_DEFAULT: Array<{
  ...
  { id: "infra_paving", category: "Infraestrutura", label: "Pavimentação", type: "manual", description: "Via pavimentada no entorno imediato do terreno" },
  { id: "infra_lighting", category: "Infraestrutura", label: "Iluminação Pública", type: "manual", description: "Iluminação pública no entorno imediato do terreno" },
